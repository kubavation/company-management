...
class LeaveRequestTest {
    ...
    void submitLeaveRequest_shouldSubmitLeaveRequest() {
        ...
        LeaveRequest leaveRequest = new DailyLeaveRequest(
                new LeaveRequestId(UUID.randomUUID()),
                LeaveRequestType.AL,
                LeaveRequestDailyPeriod.of(LocalDate.now(), LocalDate.now()),
                new ApplicantId(UUID.randomUUID()
        ));
    ...
    void cancelLeaveRequest_shouldMarkLeaveRequestAsCanceled() {
        ...
        LeaveRequest leaveRequest = new DailyLeaveRequest(
                new LeaveRequestId(UUID.randomUUID()),
                LeaveRequestType.AL, LeaveRequestDailyPeriod.of(dateFrom, dateFrom),
                new ApplicantId(UUID.randomUUID())
        );
